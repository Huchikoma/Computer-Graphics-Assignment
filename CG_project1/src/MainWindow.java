...
/*		if (Keyboard.isKeyDown(Keyboard.KEY_A))
	...
	public void renderGL() { 
		...
		if (delta1>60&&delta1<133) {
			GLU.gluLookAt(100,-40, 100,0 ,0, 0, 0, 1, 0);
		}
		if(delta1>133){
		...
		if(delta1<107)
		{
			...
			GL11.glScalef(20f, 20f,20f); //Ëõ·Å
			Human MyHuman = new Human();
			Bike Mybike = new Bike();
			 GL11.glTranslatef(-200, 0.0f,0);
			 GL11.glTranslatef(posn_a*5.0f, 0.0f,0);
		...
		if(delta1>107&&delta1<133){
			GL11.glTranslatef(500, 400,0 ); 
			GL11.glScalef(20f,20f,20f);
			player1 Myplayer1 = new player1();
			bike1 Mybike1 = new bike1();
				GL11.glTranslatef(30, 0.0f,0);
				 //GL11.glTranslatef(posn_a*5.0f, 0.0f,0);
				 GL11.glRotated(-90, 0.0f, 1.0f,0.0f);
			Myplayer1.DrawHuman(delta*20,texture,texture2); 
			Mybike1.DrawBike(delta*9, texture,texture2); 
		}
		if(delta1>133){
			GL11.glTranslatef(1080, 430,0 ); 
			GL11.glScalef(20f,20f,20f);
		...
		if(delta1<123)
		{
			GL11.glTranslatef(500, 400,100 ); 
			GL11.glScalef(20f,20f,20f);
			Human MyHuman = new Human();
			Bike Mybike = new Bike();
			GL11.glTranslatef(-30, 0.0f,0);
			 GL11.glTranslatef(posn_a, 0.0f,0);
			 GL11.glRotated(-90, 0.0f, 1.0f,0.0f);
			 MyHuman.DrawHuman(delta*20,texture,texture2); 
			 Mybike.DrawBike(delta*9, texture,texture2); 			 
		}
			...
			GL11.glTranslatef(30, 0.0f,0);
			 GL11.glRotated(-90, 0.0f, 1.0f,0.0f);
		Myplayer2.DrawHuman(delta*20,texture,texture2); 
		Mybike1.DrawBike(delta*9, texture,texture2); 
		}
		GL11.glPopMatrix();
		//down player
		...
		if(delta1<133)
		{
			GL11.glTranslatef(500, 400,350 ); 
			GL11.glScalef(20f,20f,20f);
			Human MyHuman = new Human();
			Bike Mybike = new Bike();
			GL11.glTranslatef(-40, 0.0f,0);
			 GL11.glTranslatef(posn_a, 0.0f,0);
			 GL11.glRotated(-90, 0.0f, 1.0f,0.0f);
			 MyHuman.DrawHuman(delta*20,texture,texture2); 
			 Mybike.DrawBike(delta*9, texture,texture2); 			 
