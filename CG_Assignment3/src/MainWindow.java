...
public class MainWindow {
	...
	public void renderGL() { 
		...
		{ 
			//GL11.glRotatef(theta*90, 1.0f, 0.0f,0.0f);
		
			//bad animation  version 
			 GL11.glTranslatef(posn_x*3.0f, 0.0f, posn_y*3.0f);
		}
		 
		MyHuman.DrawHuman(delta*8,!BadAnimation,texture,texture2); // give a delta for the Human object ot be animated 
		...
		if(Earth)
		{
			...
			GL11.glTexParameteri(
		 	...
		 	MyGlobe.DrawTexSphere(8f, 100, 100, texture3); 
		//	MyGlobe.DrawTexCube(); 
			GL11.glPopMatrix();
		}
	...
	Texture texture;
	Texture texture2;//chest's texture
	Texture texture3;
	...
	public void init() throws IOException {
	  ...
	  texture2 = TextureLoader.getTexture("JPG", ResourceLoader.getResourceAsStream("res/a.jpg"));
	  System.out.println("Texture 2 loaded okay ");
	  texture3 = TextureLoader.getTexture("PNG", ResourceLoader.getResourceAsStream("res/earthspace.png"));
